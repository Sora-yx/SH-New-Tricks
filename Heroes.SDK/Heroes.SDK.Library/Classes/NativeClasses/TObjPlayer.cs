...
public unsafe struct TObjPlayer
{
    ...
    public fixed byte gapD0[4];
    [FieldOffset(0xD4)]
    public Int16 jumpBallTime;
    [FieldOffset(0xD6)]
    public Int16 nocontimer;
    [FieldOffset(0xD8)]
    public Int16 idleTime;
    [FieldOffset(0xDC)]
    public Int32 nextAnimation_HHC;
    [FieldOffset(0xE0)]
    public float dotp;
    [FieldOffset(0xE4)]
    public int accel;
    ...
    public Int16 mode;
    [FieldOffset(0xF6)]
    public Int16 stateCopy;
    [FieldOffset(0xF8)]
    public Int16 smode;
    [FieldOffset(0xFA)]
    public Int16 flashTimer;
    [FieldOffset(0xFC)]
    public RwV3d acc;
    [FieldOffset(0x108)]
    public RwV3d spd;
    ...
    public int flag;
    [FieldOffset(0x1BC)]
    public int statusRelated0x1C0;
    [FieldOffset(0x1C0)]
    public byte playerStatus_0x1C0;
    [FieldOffset(0x1C4)]
    public Physics p;
    [FieldOffset(0x248)]
    public fixed byte FUCK2[0x14D];
    [FieldOffset(0x398)]
    public short animationIndex;
    [FieldOffset(0x39A)]
    public short motion;
    ...
    public short animCopy;
    [FieldOffset(0x39E)]
    public fixed byte FUCK3[0x5EA];
    [FieldOffset(0x988)]
    public fixed byte gap988[2];
    [FieldOffset(0x98A)]
    public fixed byte FUCK4[0xB6];
}*/
